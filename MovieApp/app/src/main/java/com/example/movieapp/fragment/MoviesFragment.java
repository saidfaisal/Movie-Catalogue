...
public class MoviesFragment extends Fragment implements LoadShowsCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView rvMovies = Objects.requireNonNull(getActivity()).findViewById(R.id.rv_movies);
    ...
    public void postExecute(ArrayList<Show> showsFavorites) {
        ...
        customViewModel.setDatabase(showsFavorites, "");
    ...
    static class DataObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            new MoviesFragment.LoadShowsAsync(context, (LoadShowsCallback) context).execute();
        }
    }
}
