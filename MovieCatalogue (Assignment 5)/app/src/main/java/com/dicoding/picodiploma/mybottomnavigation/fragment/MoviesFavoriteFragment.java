...
public class MoviesFavoriteFragment extends Fragment implements LoadShowsCallback {
    ...
    public void postExecute(ArrayList<Show> showsFavorites) {
        ...
        customViewModel.setDatabase(shows, "");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                customViewModel.setDatabase(listShowsFavorites, query);
